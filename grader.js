...
var getFileFromUrl = function(url, callback) {
...
if(require.main == module) {
    program
        ...
        .option('-u, --url <url>', 'URL of html document', String)
        .parse(process.argv);
	...
	var checkJson = checkHtmlFile(program.file, program.checks);
	    ...
	    fs.writeFileSync(tmphtml, data);
	    var checkJson = checkHtmlFile(assertFileExists(tmphtml), program.checks);
            output(checkJson);
        }) 
    }
